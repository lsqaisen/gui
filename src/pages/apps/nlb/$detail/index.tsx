...
const AppDetail = ({ loading, name, namespace, nlb, dispatch }: AppDetailProps) => {
...
export default connect(
  (
    ...
    return ({ name: detail, namespace: ns, nlb: (nlb.data[ns] || []).find(v => v.name === detail), loading: loading.effects['nlb/get'] })
  }
)(AppDetail)