...
const ConfigMapList = ({ loading, configmaps, ns, dispatch }: ConfigMapListProps) => {
        ...
        >
          <section className="box">
            <header style={{ overflow: 'hidden', marginBottom: 16 }}>
              ...
              <div className="fr">
                <Button style={{ marginLeft: 16 }} loading={loading} onClick={getConfigMaps}>刷新</Button>
              </div>
            </header>
            <Table
              loading={loading}
...
export default connect(({ configmap, loading }: ConnectState, { location: { query: { ns } } }: any) => ({ ns, configmaps: configmap.data[ns] || [], loading: loading.effects['configmap/get'] }))(ConfigMapList);