...
const Input = ({ canBeDeleted, actions, children }: any) => (
  ...
  >
    <Collapse.Panel header={name || '容器配置'} key="1" style={customPanelStyle} extra={canBeDeleted ? actions : undefined}>
      {children}
    </Collapse.Panel>
  </Collapse>
)
...
export default class extends React.PureComponent<any, any>{
  static readonly defaultProps = {
    form: {},
    value: [{}],
    labels: ["args", "command", "env", "image", "liveness_probe", "name", "privileged", "resources", "volume_mounts", "working_dir"],
    onChange: () => null,
  };
