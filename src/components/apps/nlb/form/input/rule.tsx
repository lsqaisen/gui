      ...
      <>
        ...
        >
          {getFieldDecorator('target_port', {
            ...
            <InputNumber style={{ width: '100%' }} min={1} max={65535} placeholder="请输入目标端口" />
          )}
        </FormItem>
        <FormItem
          {...{ labelCol, wrapperCol }}
        ...
        >
          {getFieldDecorator('port', {
            ...
            <InputNumber style={{ width: '100%' }} min={1} max={65535} placeholder="请输入导出端口" />
          )}
        </FormItem>
      </>
    )
